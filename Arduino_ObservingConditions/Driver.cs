...
//
// Implements:	ASCOM ObservingConditions interface version: 1.1.0
// Author:		Manoj Koushik (manoj.koushik@gmail.com
// Revision:    Jonathan Titton (jtitton@gmail.com)
//
// --------------------------------------------------------------------------------
...
namespace ASCOM.Arduino
{
    ...
    public class ObservingConditions : IObservingConditions
    {
        ...
        /// </summary>
        private static string driverDescription = "Arduino ObservingConditions AstroLab";
        ...
        public void boltWoodFile()
        {
            ...
            {
                LogMessage("Erro buscar altitute ascom", e.ToString());
